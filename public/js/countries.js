...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.style.color="gray";
	countryElement.style.fontSize="1.3rem";
	countryElement.style.fontWeight="100";
	countryElement.style.borderRadius="5rem";
	...
	if( stateElementId ){
		...
		stateElement.style.color="gray";
		stateElement.style.fontSize="1.3rem";
		stateElement.style.fontWeight="100";
		...
		countryElement.onchange = function(){
			...
			countryElement.style.fontWeight="400";
